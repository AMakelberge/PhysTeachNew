...
import {g, m1, m2, l1, l2} from './main.js';
...
//Allows for dynamic changing of variables
export function updatePendVars(a, b, c, d, e){
    let g = a;
    let m1 = b;
    let m2 = c;
    let l1 = d;
...
export function setPendulumPosition(canvas, event, l1, l2, th1, th2, om1, om2){
...
function getKineticEnergy(th1, th2, m1, m2, l1, l2){
...
function getPotentialEnergy(th1, th2, m1, m2, l1, l2){
...
export function drawEnergyBar(ctxEnergy, widthEnergy, heightEnergy, th1, th2, m1, m2, l1, l2){
